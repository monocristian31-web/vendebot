...
Eso le dice a Twilio "recibí el mensaje, no respondas nada" y deja que el bot envíe la respuesta por su cuenta.

Guarda el archivo con **Ctrl + S**, luego en la terminal escribe:
```
git add .
